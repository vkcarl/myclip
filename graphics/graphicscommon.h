...
private:
    ...
    public:
        ...
        virtual int type() const override {return GraphicsObjectVerticalIndicatorType;}
        virtual QRectF boundingRect() const override {return QRectF(QPointF(0, 0), QSizeF(line_size_));}
...
protected:
    virtual bool extendGrid(QPointF &rPoint, eGridPosition which) const override;
    virtual QColor ColorAdviceForGrid() const override { return color_; }
    virtual QVariant itemChange(GraphicsItemChange change, const QVariant &value) override;
    virtual void ViewTransformEvent(const QTransform& trans) override;

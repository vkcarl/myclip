...
public:
    AddTrackDetailsCommand(AbstractWidgetTrackDetails *track_details, ClipMain *widget_compostion, int trackIndex, QUndoCommand *parent = NULL);
